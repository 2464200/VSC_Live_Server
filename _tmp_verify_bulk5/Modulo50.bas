...
Private Function CheckCSVForPrefix(ByVal path As String, ByVal delimiter As String, ByVal chiave As String) As Boolean
    ...
    Do While Not ts.AtEndOfStream
        ...
        ' può essere necessario un parser più sofisticato.
...
Fallback:
    ' Se Application.Caller non è disponibile, cerca la shape con OnAction = una delle macro
    Dim shp As Shape
...
' === Apre Chrome sulla pagina indicata. Se Chrome non è trovato, usa il browser predefinito ===
