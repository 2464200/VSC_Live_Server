...
' Apre l'URL in un'istanza isolata di Chrome, in modalità app (una sola finestra, senza tab)
Public Sub OpenInChrome_IsolatedApp(ByVal URL As String)
    ...
    ' Avvia Chrome in modalità app, con profilo isolato
    Dim args As String
...
Public Sub CloseIsolatedChrome()
    ...
    For Each p In procs
        ' CommandLine può essere Null, concateno stringa vuota per sicurezza
