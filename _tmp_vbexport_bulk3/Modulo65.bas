...
Sub ApriGestorePDF()
    ...
    MsgBox "Apertura della gestione PDF..." & vbCrLf & vbCrLf & _
           "Se ? la prima volta, l'installazione potrebbe richiedere alcuni secondi.", _
...
' Nota: Per un'apertura pi? veloce senza attendere
' ============================================================
...
Sub ApriGestorePDF_Async()
    ...
    MsgBox "Gestione PDF avviata" & vbCrLf & vbCrLf & _
           "Verrai notificato quando la sessione terminer?.", _
           vbInformation, "Gestione PDF"
...
Sub ConfiguraGestorePDF()
    ...
    MsgBox "Verr? eseguita la configurazione iniziale..." & vbCrLf & vbCrLf & _
...
Sub AggiungiBottoniToolbar()
    ' Nota: Questa ? una procedura di utilit?
...
Sub TestConessione()
    ...
    If xmlHTTP.Status = 200 Then
        MsgBox "? Connessione OK" & vbCrLf & vbCrLf & _
               "Il server PDF ? attivo e funzionante.", _
...
' Seleziona il pulsante, propriet?, e assegna la macro.
