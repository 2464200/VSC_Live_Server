...
Sub EstraiBraniOrdinatiCasuale5()
    ...
    ' Ripeti finch? ci sono brani da estrarre
...
Sub AggiungiBranoOrdinato(wsRisultati As Worksheet, ByRef ultimaRigaRisultati As Long, brano As String, criterio As String)
    ...
    ' Controlla se ci sono righe gi? popolate prima di iterare
    ...
    ' Se il brano non ? gi? stato trovato, aggiungilo al foglio "Risultati"
    If Not trovato Then
