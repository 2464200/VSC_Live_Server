...
'     gi? a tutto schermo (massimizzata)
...
' Apre Chrome in modalit? "normale" su una NUOVA finestra, posizionata sul secondo monitor
' (assunto a destra del principale) e gi? a tutto schermo (massimizzata) con l'URL indicato.
' ========================================================================================
Public Sub ApriPaginaInChromeSecondoMonitorFullScreen(ByVal sUrl As String)
    ...
    '    - --start-maximized  => apre la finestra gi? massimizzata (tutto schermo)
...
GestioneErrore:
    ...
    MsgBox "Si ? verificato un errore durante l'apertura della pagina in Chrome (secondo monitor, full screen)." & vbCrLf & _
...
GestioneErrore:
    ' In caso di errore mostra un messaggio all'utente e non blocca Excel
    MsgBox "Si ? verificato un errore durante la chiusura della finestra di Chrome." & vbCrLf & _
           "Dettagli: " & Err.Number & " - " & Err.Description, _
...
' sul secondo monitor, gi? a tutto schermo (massimizzata)
...
GestioneErrore:
    ...
    MsgBox "Si ? verificato un errore nel pulsante di apertura pagina (Chrome fullscreen)." & vbCrLf & _
           "Dettagli: " & Err.Number & " - " & Err.Description, _
...
GestioneErrore:
    ' In caso di errore mostra un messaggio ma non blocca Excel
    MsgBox "Si ? verificato un errore nel pulsante di chiusura pagina (Chrome fullscreen)." & vbCrLf & _
           "Dettagli: " & Err.Number & " - " & Err.Description, _
