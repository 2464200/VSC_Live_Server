...
Public Sub TrasferisciDaBorderoConTema_DJ2()
    ...
    Set wsOrigine = ThisWorkbook.Sheets("Border?")
    ...
    ' Ciclo sulle righe del foglio Border?
    For r = 12 To lastRow
        ...
        If valoreG <> "" Then
            ...
            ' Se c'? "X" in colonna A ? importa sempre
            ' Altrimenti importa solo se non ? gi? stato importato (controllo duplicati su colonna D)
