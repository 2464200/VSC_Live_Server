...
const BORDERO_CONFIG = {
  ...
  CACHE_KEY_LOCATION: 'bordero_location',
  CACHE_KEY_LOCATION_OPTIONS: 'bordero_location_options',
  ...
  FIREBASE_REALTIME_DB_URL: 'https://my-project-1525790600392-default-rtdb.firebaseio.com',
  ...
  DISPLAY_SCROLL_SPEED_PX_PER_SECOND: 30,
  DISPLAY_SCROLL_SPEED_STORAGE_KEY: 'BORDERO_DISPLAY_SCROLL_SPEED_PXPS',
  DISPLAY_SCROLL_SETTINGS_STORAGE_KEY: 'BORDERO_DISPLAY_SCROLL_SETTINGS',
  DISPLAY_SCROLL_COMMAND_STORAGE_KEY: 'BORDERO_DISPLAY_SCROLL_COMMAND',
  DISPLAY_SCROLL_DEFAULT_STEP_MS: 16,
  DISPLAY_SCROLL_DEFAULT_PAUSE_SEC: 1,
  DISPLAY_SCROLL_DEFAULT_STEP_PX: 1,
