...
class AdminPanel {
  ...
  getMonitorPageRouteDefaults() {
    return [
      ...
      { path: '/bordero/index.html', primary: true, secondary: false },
      ...
      { path: '/bordero/pages/coreografie-stampa.html', primary: true, secondary: false },
      ...
      { path: '/eventi/public/eventi.html', primary: true, secondary: false },
      { path: '/eventi/admin.html', primary: true, secondary: false },
      { path: '/eventi/coreografie-aggiuntive.html', primary: true, secondary: false },
      { path: '/eventi/dj-manager.html', primary: true, secondary: false },
      { path: '/eventi/documentation.html', primary: true, secondary: false },
      { path: '/eventi/non-spuntati.html', primary: true, secondary: false },
      { path: '/eventi/prenotati.html', primary: true, secondary: false },
      { path: '/eventi/qr.html', primary: true, secondary: false },
      { path: '/eventi/spuntati.html', primary: true, secondary: false },
      { path: '/eventi/statistiche-dj.html', primary: true, secondary: false },
      { path: '/eventi/tutti.html', primary: true, secondary: false },
      { path: '/eventi/visualizer.html', primary: true, secondary: false },
      { path: '/diagnostica.html', primary: true, secondary: false },
      { path: '/scriptpdf1.html', primary: true, secondary: false },
      { path: '/prova/scriptpdf1.html', primary: true, secondary: false },
      { path: '/prova/report.html', primary: true, secondary: false },
      { path: '/prova/report_black.html', primary: true, secondary: false },
      { path: '/prova/report_white.html', primary: true, secondary: false },
      { path: '/prova/logo.html', primary: true, secondary: false },
      { path: '/prova/image.html', primary: true, secondary: false },
      { path: '/vdj/test-vdj.html', primary: true, secondary: false },
      ...
      { path: '/userform/pages/webcam.html', primary: true, secondary: false },
  ...
  getMonitorPageRoutes() {
    return [
      ...
      { path: '/bordero/index.html', label: 'Bordero Home', description: 'Home del modulo Bordero' },
      ...
      { path: '/bordero/pages/coreografie-stampa.html', label: 'Stampa Coreografie', description: 'Generazione stampe A4 per coreografie' },
      ...
      { path: '/eventi/public/eventi.html', label: 'Eventi Pubblici', description: 'Vista pubblica del modulo Eventi' },
      { path: '/eventi/admin.html', label: 'Eventi Admin', description: 'Pannello amministrazione modulo Eventi' },
      { path: '/eventi/coreografie-aggiuntive.html', label: 'Coreografie Aggiuntive', description: 'Elenco coreografie aggiuntive Eventi' },
      { path: '/eventi/dj-manager.html', label: 'Gestione DJ', description: 'Gestione DJ modulo Eventi' },
      { path: '/eventi/documentation.html', label: 'Documentazione Eventi', description: 'Documentazione modulo Eventi' },
      { path: '/eventi/non-spuntati.html', label: 'Non Eseguite', description: 'Coreografie non eseguite Eventi' },
      { path: '/eventi/prenotati.html', label: 'Prenotate', description: 'Coreografie prenotate Eventi' },
      { path: '/eventi/qr.html', label: 'QR Code Eventi', description: 'QR Code di connessione Eventi' },
      { path: '/eventi/spuntati.html', label: 'Eseguite', description: 'Coreografie eseguite Eventi' },
      { path: '/eventi/statistiche-dj.html', label: 'Statistiche DJ', description: 'Statistiche DJ modulo Eventi' },
      { path: '/eventi/tutti.html', label: 'Mostra Tutte', description: 'Elenco completo coreografie Eventi' },
      { path: '/eventi/visualizer.html', label: 'Visualizer', description: 'Visualizer pubblico modulo Eventi' },
      { path: '/diagnostica.html', label: 'Diagnostica', description: 'Sistema e routing dei servizi' },
      { path: '/scriptpdf1.html', label: 'ScriptPDF1', description: 'Pagina PDF/ScriptPDF1' },
      { path: '/prova/scriptpdf1.html', label: 'Prova ScriptPDF1', description: 'Pagina di prova PDF/ScriptPDF1' },
      { path: '/prova/report.html', label: 'Report Prova', description: 'Pagina di report di prova' },
      { path: '/prova/report_black.html', label: 'Report Black', description: 'Pagina report in tema scuro' },
      { path: '/prova/report_white.html', label: 'Report White', description: 'Pagina report in tema chiaro' },
      { path: '/prova/logo.html', label: 'Logo Prova', description: 'Pagina di preview logo' },
      { path: '/prova/image.html', label: 'Immagine Prova', description: 'Pagina di preview immagine' },
      { path: '/vdj/test-vdj.html', label: 'VDJ Test', description: 'Pagina test VDJ' },
      ...
      { path: '/userform/pages/webcam.html', label: 'Webcam', description: 'Pagina webcam del form USERFORM' },
