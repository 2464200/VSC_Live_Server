...
Sub MacroWrapper()
    ...
    ' Recupera il nome della macro dalla proprietà AlternateText
    ...
    If nomeMacro <> "" Then
        ...
        On Error GoTo 0
    Else
        MsgBox "Non è stato trovato alcun nome della macro nella proprietà AlternateText della forma " & shp.name, vbExclamation
    End If
End Sub
...
Sub SetupShapes()
    ...
    For Each ws In ThisWorkbook.Worksheets
        ...
        For Each shp In ws.Shapes
            ' Se la forma ha già assegnata una macro (diversa dal wrapper)...
            If shp.OnAction <> "" And shp.OnAction <> "MacroWrapper" Then
                ' Memorizza il nome della macro originale nella proprietà AlternateText
